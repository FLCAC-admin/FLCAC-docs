...
Commons Merged is a merged data package that compiles versions of existing data packages (or repositories) on the Federal LCA Commons and combines them as intended by the original authors.
Where appropriate, this data package fills in default providers and aligns technosphere flows across source data packages.

## Why Commons Merged?
Commons Merged prevents users from needing to download multiple data packages individually and manually connecting data across them.
...
## Details
Within Commons Merged, individual processes are labeled with Tags based on their source data package.
...
:::{caution} Disclaimer
Commons Merged includes a mixture of industry-supplied data and data from federal agencies and has not undergone additional review, nor does it constitute or imply an endorsement by the agencies of the Federal LCA Commons.
:::

## Releases

Versions of Commons Merged which are available on the FLCAC are listed below with their compiled data packages.
