...
- With all databases closed, select 'Database', select 'New database', select 'From repository...'. (Or right-click in the navigation pane and select 'New database', 'From repository...')
