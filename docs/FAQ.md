...
As of the June 2026 release of the USLCI (v1.2026-06.0), an option to use updated natural gas supply chain data from Argonne National Laboratory's [GREET model](https://greet.anl.gov/index.php) is available. Note the older natural gas supply chain data will be phased out over the next quarter and GREET will become the primary source.
